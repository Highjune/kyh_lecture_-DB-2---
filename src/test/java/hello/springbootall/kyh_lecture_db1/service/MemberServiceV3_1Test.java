...
import hello.springbootall.kyh_lecture_db1.repository.MemberRepositoryV2;
import hello.springbootall.kyh_lecture_db1.repository.MemberRepositoryV3;
import hello.springbootall.kyh_lecture_db1.service.MemberServiceV2;
...
public class MemberServiceV3_1Test {
    ...
    void before() {
        ...
        memberService = new MemberServiceV3_1(transactionManager, memberRepository); // 주입
    }
    ...
    @Test
    @DisplayName("이체중 예외 발생_트랜잭션X(auto commit)")
